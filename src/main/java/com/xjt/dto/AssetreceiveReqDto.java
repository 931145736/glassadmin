 ...
 * @date 2019-11-15
 */
public class AssetreceiveReqDto extends BaseReqDto {
    /**
     * 领用表id
     */
    ...
    private List<Assetreceivedetail> details;
    ...
    public List<Assetreceivedetail> getDetails() {
        return details;
    }

    public void setDetails(List<Assetreceivedetail> details) {
