 ...
 * @date 2019-11-07
 */
public class PureceiptgoodsReqDto extends BaseReqDto {
    /**
     * 厂家来货货品表
     */
    ...
    private List<PureceiptdetailReqDto> pureceiptdetailList;
    ...
    public List<PureceiptdetailReqDto> getPureceiptdetailList() {
        return pureceiptdetailList;
    }

    public void setPureceiptdetailList(List<PureceiptdetailReqDto> pureceiptdetailList) {
        this.pureceiptdetailList = pureceiptdetailList;
    }
}