...
import com.xjt.fileupload.common.FileTypeConst;
...
public class VerifyFileTypeUtil {
    ...
    public static boolean isOfficeFile(File file) {
        ...
        try {
            ...
            return OFFICE_TYPE_MAP.keySet().contains(fileCode.toLowerCase());
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        } finally {
    ...
    public static boolean isImageFile(File file) {
        ...
        try {
            ...
            return IMG_TYPE_MAP.keySet().contains(fileCode.toLowerCase());
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        } finally {
    ...
    public static boolean isSupportFile(File file) {
        ...
        try {
            ...
            return FILE_TYPE_MAP.keySet().contains(fileCode.toLowerCase());
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        } finally {
    ...
    public static String getImageType(File file) {
        ...
        try {
            ...
            Iterator<String> keyIter = IMG_TYPE_MAP.keySet().iterator();
    ...
    public static String getTypeName(String extensionName) {
        ...
        if (TYPE_NAME_MAP.containsKey(extensionName)) {
            return TYPE_NAME_MAP.get(extensionName);
        } else {
            return "";
        }
    }
